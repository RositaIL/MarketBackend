...
public record UsuarioDTO(
        ...
        @Email(groups = {OnCreate.class, OnUpdate.class},message = "- Debe ser un correo electrónico válido")
        @Size(groups = {OnCreate.class, OnUpdate.class},max = 50, message = "- El correo electrónico no debe exceder los 50 caracteres")
        String emailUsu,

        @NotEmpty(groups = OnCreate.class,message = "- Debe especificar el login de usuario")
        @Size(groups = {OnCreate.class, OnUpdate.class},min = 5, max = 15, message = "- El login de usuario debe medir entre 5 y 15 caracteres")
        String username,
